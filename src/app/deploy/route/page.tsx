...
export default function RoutePage() {
    ...
    return (
        <div className="space-y-6">
            ...
            <RequirementGate>
                <Panel title="Route Preview" description="Preview how capital will be allocated">
                    <EmptyState
                        title="No routing preview available"
                        body="Deployment previews and routing details will appear here before execution."
                    />
                </Panel>
                <ExternalObservability ecosystem={ecosystem} />
            </RequirementGate>
